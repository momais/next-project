...
<div className="block lg:hidden sm:py-4 sm:md:px-7 py-3 px-3 mb-5 bg-white border 
  ...
  <form action="#" className="row">
    ...
    <div className="w-full lg:w-[50%] pr-0 lg:pr-3 mb-6">
      ...
      <input required className="w-full py-3 px-4 h-13 outline-none rounded-xl border border-black bg-white duration-500 focus:bg-light" />
    </div>
   ...
   <div className="flex flex-wrap">
    <div className="w-full lg:w-[50%] pr-0 lg:pr-3 mb-6">
      ...
      <input type="email" required className="w-full py-3 px-4 h-13 outline-none rounded-xl border border-black bg-white duration-500 focus:bg-light" />
    </div>
    <div className="w-full lg:w-[50%] pl-0 lg:pl-3 mb-6">
      <label className="mb-2.5 inline-block">Phone</label>
      <input type="text" required className="w-full py-3 px-4 h-13 outline-none rounded-xl border border-black bg-white duration-500 focus:bg-light" />
    </div>
  </div>
    ...
    <div className="w-full lg:w-[50%] pr-0 lg:pr-3 mb-6">
      ...
      <input type="password" required className="w-full py-3 px-4 h-13 outline-none rounded-xl border border-black bg-white duration-500 focus:bg-light" />
    </div>
    <div className="w-full lg:w-[50%] pl-0 lg:pl-3 mb-6">
              ...
              <div className="flex flex-wrap justify-between items-center">
                <div>
                  <div className="custom-control custom-checkbox text-black">
                    ...
                    <label className="form-check-label font-base ml-2" for="basic_checkbox_1">Subscribe me to Newsletter</label>
                  </div>
                </div>
                <button className="btn py-3.5 px-7 max-sm:px-6 text-base max-sm:text-sm inline-block font-medium leading-[1.2] border border-primary bg-[#d9144e] text-white rounded-xl duration-700 relative overflow-hidden mt-4 sm:mt-0" type="button">Update profile</button>
              </div>
            </div>
          </section>
