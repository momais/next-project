                ...
                <table className="table-hover min-w-[600px] mb-4 w-full text-left">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <a href="#" className="fw-medium">#34VB5540K83</a></td>
                      ...
                      <td className="py-4 px-3 text-body border-t border-border">
                      <span className="py-1 px-2.5 text-white rounded-md uppercase text-center text-xs leading-[1] inline-block font-semibold bg-info  m-0">In Progress</span></td>
                      <td className="py-4 px-3 text-body border-t border-border text-right">
                      <a href="#" className="text-primary underline p-0">View</a></td>
                    </tr>
                    <tr>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <a href="#" className="fw-medium">#78A643CD409</a></td>
                      <td className="py-4 px-3 text-body border-t border-border">December 09, 2024</td>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <span>$760.50</span></td>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <span className="py-1 px-2 text-white rounded-md uppercase text-center text-xs leading-[1] inline-block font-semibold bg-danger  m-0">Canceled</span></td>
                      <td className="py-4 px-3 text-body border-t border-border text-right">
                      <a href="#" class="text-primary underline p-0">View</a></td>
                    </tr>
                    <tr>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <a href="#" className="fw-medium">#112P45A90V2</a></td>
                      ...
                      <td className="py-4 px-3 text-body border-t border-border">
                      <span className="py-1.1 px-2.5 text-white rounded-md uppercase text-center text-xs leading-[1] inline-block font-semibold bg-warning  m-0">Delayed</span></td>
                      <td className="py-4 px-3 text-body border-t border-border text-right">
                      <a href="#" className="text-primary underline p-0">View</a></td>
                    </tr>
                    <tr>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <a href="#" className="fw-medium">#28BA67U0981</a></td>
                      ...
                      <td className="py-4 px-3 text-body border-t border-border">
                      <span className="py-1.1 px-2.5 text-white rounded-md uppercase text-center text-xs leading-[1] inline-block font-semibold bg-success  m-0">Delivered</span></td>
                      <td className="py-4 px-3 text-body border-t border-border text-right">
                      <a href="#" className="text-primary underline p-0">View</a></td>
                    </tr>
                    <tr>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <a href="#" className="fw-medium">#502TR872W2</a></td>
                    ...
                    <tr>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <a href="#" className="fw-medium">#47H76G09F33</a></td>
                    ...
                    <tr>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <a href="#" className="fw-medium">#53U76G09E38</a></td>
                    ...
                    <tr>
                      <td className="py-4 px-3 text-body border-t border-border">
                      <a href="#" className="fw-medium">#31M76G09G76</a></td>
