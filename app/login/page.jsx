...
{/* large left */}
          <div className="col-xxl-6 lg:w-1/2 hidden md:block w-full relative bg-[#FFEDD4] start-side-content p-4 flex flex-col items-center lg:items-start">
            <div className="dz-bnr-inr-entry">
              ...
              <nav className="mb-4">
                <ul>
                  ...
                  <li className="mr-[3px] inline-block text-base font-base before:pr-2">My Account</li>
                </ul>
              </nav>
            </div>
            ...
            <div className="text-center sm:text-center relative z-10 m-auto mt-10 mb-4 max-3xl:mt-0 registration-media">
              <img src="assets/images/registration/pic3.png" className="w-[300px] sm:w-[350px] 
              md:w-[410px] mx-auto" width={410} height={410} alt="Account" />
            </div>
          ...
          <div className="col-xxl-6 lg:w-1/2 w-full flex flex-col end-side-content p-4">
            <div className="p-6 max-w-[522px] m-auto rounded-3xl border border-black w-full sm:p-5 lg:p-20 max-xl:p-7.5 max-sm:!p-3.6">
              <h2 className="mb-2 text-center text-3xl font-bold">Login</h2>
              <p className="text-center mb-9 text-base text-gray-700">Welcome please login to your account</p>
             
              <form onSubmit={handleLogin}>
                <div className="mb-6">
                  <label className="block font-medium font-Lufga mb-2">Email Address</label>
        ...
        >
          ...
          {!showPassword ? <EyeOff size={20} /> : <Eye size={20} />}
                ...
                <div className="form-row flex justify-between mb-9">
                  ...
                  <div className="form-group">
                    <a className="text-red-700 font-md" href="#">Forgot Password</a>
                  </div>
                </div>
                <div className="text-center">
                 <button type="submit" className="btn py-3 px-9 max-sm:px-6 text-base max-sm:text-sm 
                   inline-block font-medium leading-[1.2] border border-black bg-black text-white 
                    rounded-xl duration-700 relative uppercase mr-2">
                     Sign In
                  </button>

                  <Link href="/register" className="btn py-3 px-7 max-sm:px-6 text-base max-sm:text-sm 
