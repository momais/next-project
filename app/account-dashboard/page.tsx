            ...
            <section className="w-full max-w-[1000px] mx-auto p-4 md:pl-9 mt-[50%] md:mt-0">
              ...
              <div className="border border-black/10 p-7 rounded-xl min-h-[250px] max-sm:p-5">
                <div className="mb-2 p-2">
                  <p className="mb-4 text-body">Hello <strong className="text-black">{session.user?.name}</strong>
                  (not <strong className="text-black">{session.user?.name}</strong>? 
                  ...
                  <p>From your account dashboard you can view your
                    ...
                    <a href="#" className="underline hover:text-red-700">shipping and billing addresses</a>, 
                    and <a href="#" className="underline hover:text-red-700">edit your password and account details</a>.
                  </p>
                </div>
