    ...
    <div>
                ...
                <div className="w-full lg:w-7/12">
                  <div className="max-sm:mb-7">
                    ...
                    <div className="flex flex-nowrap items-center text-center justify-start gap-4 max-sm:gap-2 
                      ...
                      <Link href="#" className="btn py-3 px-5 text-base max-sm:text-sm inline-block font-medium 
                      ...
                      <Link href="#" className="btn py-3 px-5 text-base max-sm:text-sm inline-block 
                ...
                <div className="w-full lg:w-5/12 flex justify-center lg:justify-end">
                  <div className="relative w-full max-w-[500px]">
                    ...
                    <div className="w-[200px] p-4 border absolute top-[38%] right-[1vw] duration-700 rounded-2xl 
                      ...
                      <div className="relative z-1 max-xl:pt-3">
                        ...
                        <div className="bg-red-700 border size-[35px] max-sm:size-4.5 max-sm:group-hover:-bottom-2.5 bg-primary 
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 24 24" fill="white" aria-hidden="true">
                    ...
                    <div className="p-4 absolute bottom-[17%] border left-[3vw] duration-700 rounded-2xl 
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgb(185, 28, 28)" aria-hidden="true">
                      ...
                      <ul className="flex px-2.5">
                        <li className="min-w-14.5 size-14.5 rounded-full -ml-2.5">
                          <Image 
                            ...
                            width={56}
                            height={56}
                            className="border-2 border-white rounded-full size-full"
                          />
                        </li>
                        <li className="min-w-14.5 size-14.5 rounded-full -ml-2.5">
                          <Image 
            ...
            <div className="absolute top-7 -left-2 xl:block hidden">
              <ul className="flex items-center flex-col">
                {socialLinks.map((link) => (
                  <li key={link.name} className="py-5 [writing-mode:tb-rl]">
                    <Link 
                      href={link.href} 
      ...
      <div className="relative z-1 bg-yellow-200 py-16 px-8 max-md:px-5 rounded-3xl mt-16 md:mt-2">
        <div className="container mx-auto">
          <div className="grid grid-cols-12 gap-8 max-lg:grid-cols-3 max-md:grid-cols-2">
            {/* Jacket Category */}
            <div className="col-span-4 max-lg:col-span-1 max-md:col-span-1 relative ml-[10%]">
              <Link href="#" className="relative block group">
                <Image 
                  src="/assets/images/category/pic1.jpg" 
                  alt="Jacket"
                  width={300}
                  height={250}
            ...
            <div className="col-span-4 max-lg:col-span-1 max-md:col-span-1 relative ml-[20%]">
              <Link href="#" className="relative block group">
                <Image 
                  src="/assets/images/category/pic2.jpg" 
                  alt="Jeans"
                  width={220}
                  height={250}
            ...
            {/* Shirts Category */}
            <div className="col-span-4 max-lg:col-span-1 max-md:col-span-1 relative md:mt-0 mt-6 ml-[10%]">
              <Link href="#" className="relative block group">
                <Image 
                  src="/assets/images/category/pic3.jpg" 
                  alt="Shirts"
                  width={300}
                  height={250}
                  className="w-[300px] h-[250px] max-md:w-[180px] max-md:h-[150px] object-cover border-4 border-white rounded-3xl rounded-ee-[60px] max-md:rounded-ee-[30px] transition-transform duration-300 group-hover:scale-105"
            ...
            <div className="col-span-4 max-lg:col-span-1 max-md:col-span-1 relative top-[15%] ml-[7%]">
              <Link href="#" className="relative block group">
                <Image 
                  src="/assets/images/category/pic4.jpg" 
                  alt="Shorts"
                  width={280}
                  height={250}
        ...
        <div className="lg:hidden absolute top-[75%] -left-6 bg-white px-4 py-1 font-semibold rounded-full text-md shadow-md">
          ...
          <div className="hidden md:block absolute top-[75%] right-8 font-semibold bg-white px-4 py-1 rounded-full text-md shadow-md">
            ...
            <div className="col-span-4 max-lg:col-span-1 max-md:col-span-1 relative top-[15%] ml-[2%]">
              <Link href="#" className="relative block group">
                <Image 
                  src="/assets/images/category/pic5.jpg" 
                  alt="T-Shirt"
                  width={300}
                  height={250}
                ...
                <div className="flex justify-between gap-6 w-full max-sm:grid max-sm:grid-cols-2 max-sm:gap-4 max-sm:justify-center">
                  ...
                  <div className="w-1/5 max-sm:w-[78%] flex flex-col items-center">
                    <div className="shop-box">
                      <div className="mb-4 text-center relative overflow-hidden">
                        <Image 
                          src="/assets/images/shop/product/clothes/1.png" 
                          alt="Shirts"
                          width={112}
                          height={130}
                      ...
                      <h6 className="text-sm font-medium bg-white text-center w-fit m-auto py-1 px-3 rounded-3xl border border-black">
                        <Link href="#" className="hover:text-primary">Shirts</Link>
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="w-1/5 max-sm:w-[78%] flex flex-col items-center">
                    <div>
                      <div className="mb-4 text-center relative overflow-hidden">
                        <Image 
                          src="/assets/images/shop/product/clothes/2.png" 
                          alt="Shorts"
                          width={112}
                          height={130}
                          className="w-28 h-[130px] max-sm:w-54 max-sm:h-[150px] object-contain mx-auto"
                      ...
                      <h6 className="text-sm font-medium bg-white text-center w-fit m-auto py-1 px-3 rounded-3xl border border-black">
                        <Link href="#" className="hover:text-primary">Shorts</Link>
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="w-1/5 max-sm:w-[48%] flex flex-col items-center hidden md:block">
                    <div>
                      <div className="mb-4 text-center relative overflow-hidden">
                        <Image 
                          src="/assets/images/shop/product/clothes/3.png" 
                          alt="T-Shirt"
                          width={112}
                          height={130}
                      ...
                      <h6 className="text-sm font-medium bg-white text-center w-fit m-auto py-1 px-3 rounded-3xl border border-black">
                        <Link href="#" className="hover:text-primary">T-Shirt</Link>
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="w-1/5 max-sm:w-[48%] flex flex-col items-center hidden md:block">
                    <div>
                      <div className="mb-4 text-center relative overflow-hidden">
                        <Image 
                          src="/assets/images/shop/product/clothes/4.png" 
                          alt="Jeans"
                          width={112}
                          height={130}
                          className="w-28 h-[130px] max-sm:w-24 max-sm:h-[110px] object-contain mx-auto"
                      ...
                      <h6 className="text-sm font-medium bg-white text-center w-fit m-auto py-1 px-3 rounded-3xl border border-black">
                        <Link href="#" className="hover:text-primary">Jeans</Link>
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="w-1/5 max-sm:w-[48%] flex flex-col items-center hidden md:block">
                    <div>
                      <div className="mb-4 text-center relative overflow-hidden">
                        <Image 
                          src="/assets/images/shop/product/clothes/5.png" 
                          alt="Coat"
                          width={112}
                          height={130}
                          className="w-28 h-[130px] max-sm:w-24 max-sm:h-[110px] object-contain mx-auto"
                      ...
                      <h6 className="text-sm font-medium bg-white text-center w-fit m-auto py-1 px-3 rounded-3xl border border-black">
                        <Link href="#" className="hover:text-primary">Coat</Link>
                      </h6>
                    </div>
                  </div>
          ...
          <div className="flex flex-wrap items-center">
            ...
            <div className="lg:w-5/12 w-full flex md:justify-end sm:justify-center mt-20 pr-5">
              <div className="wow fadeInUp" data-wow-delay="0.8s">
                <Image 
                  src="/assets/images/lady3.png" 
                  alt="Lady"
                  width={480}
                  height={600}
                  className="rounded-3xl w-full lg:max-w-[480px] max-sm:max-w-[400px]"
                />
              </div>
            </div>
          </div>
        ...
        <div className="container max-w-[1200px] mx-auto">
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4 md:gap-6">
            ...
            <div className="flex items-center justify-center bg-white h-16 md:h-20 rounded-xl shadow-md p-3">
              <Image 
                src="/assets/images/companies/logo1.png" 
                alt="Company 1"
                width={80}
                height={80}
            ...
            <div className="flex items-center justify-center bg-white h-16 md:h-20 rounded-xl shadow-md p-3">
              <Image 
                src="/assets/images/companies/logo2.png" 
                alt="Company 2"
                width={80}
                height={80}
                className="w-16 md:w-20"
            ...
            <div className="flex items-center justify-center bg-white h-16 md:h-20 rounded-xl shadow-md p-3">
              <Image 
                src="/assets/images/companies/logo3.png" 
                alt="Company 3"
                width={80}
                height={80}
                className="w-16 md:w-20"
            ...
            <div className="flex items-center justify-center bg-white h-16 md:h-20 rounded-xl shadow-md p-3">
              <Image 
                src="/assets/images/companies/logo4.png" 
                alt="Company 4"
                width={80}
                height={80}
                className="w-16 md:w-20"
            ...
            <div className="flex items-center justify-center bg-white h-16 md:h-20 rounded-xl shadow-md p-3">
              <Image 
                src="/assets/images/companies/logo5.png" 
                alt="Company 5"
                width={80}
                height={80}
                className="w-16 md:w-20"
            ...
            <div className="flex items-center justify-center bg-white h-16 md:h-20 rounded-xl shadow-md p-3">
              <Image 
                src="/assets/images/companies/logo6.png" 
                alt="Company 6"
                width={80}
                height={80}
                className="w-16 md:w-20"
            ...
            shadow-md p-3">
              <Image 
                src="/assets/images/companies/logo7.png" 
                alt="Company 7"
                width={80}
                height={80}
                className="w-16 md:w-20 ml-7 mt-3"
              />
            </div>
            ...
            shadow-md p-3">
              <Image 
                src="/assets/images/companies/logo8.png" 
                alt="Company 8"
                width={80}
                height={80}
                className="w-16 md:w-20 ml-7 mt-3"
